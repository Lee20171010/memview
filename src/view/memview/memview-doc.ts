...
export class MemViewPanelProvider implements vscode.WebviewViewProvider, vscode.UriHandler {
    ...
    public static register(context: vscode.ExtensionContext) {
        ...
        const viewTypes = [
            ...
            'memory-view.memoryView6',
            'memory-view.memoryView7',
            'memory-view.memoryView8',
            'memory-view.memoryView9'
        ];
    ...
    private getContextKey(): string {
        ...
        if (match) {
            return `memory-view:showMemoryPanel${match[1]}`;
        }
        return '';
    }
                ...
                switch (body.type) {
                    ...
                    case CmdType.ButtonClick: {
                        ...
                        switch (button) {
                            ...
                            case 'close-panel': {
                                if (Object.keys(this.manager.allDocuments).length > 0) {
                                    vscode.window.showInformationMessage('Please close all memory views before closing the panel.');
                                    break;
                                }
                                ...
                                this.manager.clearAllDocuments();
                                this.updateHtmlForInit();
                                break;
                            }
                        }
